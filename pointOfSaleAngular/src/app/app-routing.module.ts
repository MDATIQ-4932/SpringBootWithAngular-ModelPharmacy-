...
import { DhanmondiBranchComponent } from "./dhanmondi-branch/dhanmondi-branch.component";
...
const routes: Routes = [
  ...
  {path:"salesdhanmondibranch",component:DhanmondiBranchComponent},
  ...
  {path:"dhanmondiinvoice",component:InvoiceComponent},

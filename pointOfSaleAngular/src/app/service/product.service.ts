...
findProductByCatId(catId: number):  Observable<ProductModule[]> {

  return this.httpClient.get<ProductModule[]>(`${this.baseUrl}/category/${catId}`,);
  ...
  findProductByBranchName(branchName: string): Observable<ProductModule[]> {
    ...
    return this.httpClient.get<ProductModule[]>(`${this.baseUrl}/branch/${branchName}`, { params });
  }
  ...
  getAllDhanmondiBrancesProduct(): Observable<ProductModule[]> {
    return this.httpClient.get<ProductModule[]>(this.baseUrl+"/branch/Dhanmondi");
  }


  getAllBonaniBrancesProduct(): Observable<ProductModule[]> {
    return this.httpClient.get<ProductModule[]>(this.baseUrl+"/branch/Banani");
  }

  getAllGulshanBrancesProduct(): Observable<ProductModule[]> {

    return this.httpClient.get<ProductModule[]>(this.baseUrl+"/branch/Gulsan");
